# Note
I wouldn't recommend using this as I have ported the official BeamMP launcher to Linux. The port is available [here](https://github.com/BeamMP/BeamMP-Launcher/tree/linux).
